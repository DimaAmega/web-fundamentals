...
1. Откройте терминал и перейдите в папку, в которой будет находится код курса в будущем:
...
```
Эта команда также потребует вас авторизоваться на github, введя специальный код из терминала на сайте github. Просто читайте что происходит в терминале и следуйте инструкциям.
